...
for(t in 1:trials){
  ...
  y <- exact_sample_mixture(p_true, n, K, mu_true, rep(sigma2, K))
...
#save
#saveRDS(P_rstore1, file = "Normal_mixtures_alpha1_r1.rds")
#saveRDS(P_rstore2, file = "Normal_mixtures_alpha1_r2.rds")
#saveRDS(P_nrstore1, file = "Normal_mixtures_alpha1_nr1.rds")
#saveRDS(P_nrstore2, file = "Normal_mixtures_alpha1_nr2.rds")
#plots
#1)
#reversible
