...
#save
#saveRDS(P_rstore1, file = "Overfitted_mixtures_alpha01_r1.rds")
#saveRDS(P_nrstore1, file = "Overfitted_mixtures_alpha01_nr1.rds")
#plots
#1)
#reversible
...
hist(P_rstore1[,iterations], main = "Marginal", freq = F, ylab = "", xlab = "", col = "black", xlim = c(0,1), breaks = 10)
#non reversible
...
hist(P_nrstore1[,iterations], main = "Non reversible", freq = F, ylab = "", xlab = "", col = "black", xlim = c(0,1), breaks = 10)
